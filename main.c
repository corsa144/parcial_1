    ...
    do
    {
        ...
        switch(opcion)
        {
            ...
            case 11:
            	...
            	break;
            case 12:
            	 busca_clienteConMasKilos(pedidoVector,QTY_PEDIDO,&clienteIdAux,&cantidadDeKilosAux);
            	 cliente_buscarId(clienteVector,QTY_TIPO,&clienteIdAux, &posicionAux);
            	 listarUnCliente(clienteVector,posicionAux);
            	//listaClienteCon_masKilosPedidos(pedidoVector,QTY_PEDIDO,&clienteIdAux,clienteVector,QTY_TIPO,&posicionAux,&cantidadDeKilosAux);
            	break;
            case 13:
            	break;
            default:
